...
COPY ["FloraCore.csproj", "./"]
RUN dotnet restore "FloraCore.csproj"
...
RUN dotnet publish "FloraCore.csproj" -c Release -o /app/publish /p:UseAppHost=false
...
ENTRYPOINT ["dotnet", "FloraCore.dll"]
