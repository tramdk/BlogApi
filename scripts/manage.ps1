# scripts/manage.ps1
# Unified project management and validation script for FloraCore.
...
powershell.exe -ExecutionPolicy Bypass -Command "./scripts/manage.ps1 validate-all"
if [ $? -ne 0 ]; then
...
powershell.exe -ExecutionPolicy Bypass -Command "./scripts/manage.ps1 run-tests"
if [ $? -ne 0 ]; then
...
powershell.exe -ExecutionPolicy Bypass -Command "./scripts/manage.ps1 deploy"
